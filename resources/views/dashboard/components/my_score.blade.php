                ...
                <div class="info-box-content col">
                    ...
                    @else
                        @switch($quarterTotalScore)
                            @case($quarterTotalScore >= ($quarterTarget * 2))
                                ...
                                <h5>
                                    ...
                                    PARABÉNS!!! VOCÊ DOBROU A META DE {{ number_format($quarterTarget, 0, '', '.') }}
                                    PONTOS
                                    DESTE
                                    TRIMESTRE.
                            ...
                            @case($quarterTotalScore >= $quarterTarget)
                                <div class="progress">
                                    @if($quarterTarget)
                                        ...
                                        <div class="progress-bar" role="progressbar"
                                             style="width: {{ 50 * $quarterTotalScore / $quarterTarget }}%;"></div>
                                    @else
                                        <div class="progress-bar" style="width: 0%"></div>
                                    @endif
                                </div>
                                <h5>
                                    <i class="fas fa-trophy mr-2"></i>
                                    VOCÊ ATINGIU A META <p style="color: #ffbf00; display: inline">
                                        GOLD</p> {{ number_format($quarterTarget, 0, '', '.') }} PONTOS
                                    DESTE
                                    TRIMESTRE.
                                </h5>
                                <span class="info-box-number">
                        MEUS PONTOS: {{ number_format($quarterTotalScore, 0, '', '.') }}
                                ...
                                <span class="progress-description" style="white-space: normal;">
                        Falta {{ number_format(($quarterTarget * 2) - $quarterTotalScore , 0, '', '.') }} ponto(s) para você se tornar <strong>Platina</strong>
                    </span>
                                @break
                            @default
                                <div class="progress">

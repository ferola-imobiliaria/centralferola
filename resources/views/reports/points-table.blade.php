                ...
                <div class="form-group col-sm">
                    <select class="form-control select2bs4" name="realtor" id="realtor" style="width: 100%;">
                        ...
                        <optgroup label="{{ $team->name }}">
                            ...
                            <option value="{{ $user->id }}" @if(($realtorSelected ?? 0)==$user->id) selected @endif>
                                {{ $user->name_short }}
                            </option>
                            @endforeach
                        </optgroup>
            ...
            <table class="table table-hover text-center pointsTable" id="pointsTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" id="scorePlaques" data-score="{{ $pointsTable->score_plaques ?? 0 }}">
                            Placas ({{ $pointsTable->score_plaques ?? 0 }} pts)
                        </th>
                        <th scope="col" id="scoreSales" data-score="{{ $pointsTable->score_sales ?? 0 }}">
                ...
                <tfoot>
                    <tr class="bg-gray-light">
                        ...
                        <td class="text-center text-bold totalQuarterPoints">
                            {{ number_format($myPoints, 0, '', '.') }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill"
                                        href="#targets" role="tab" aria-controls="custom-tabs-four-profile"
                                        aria-selected="false">
                                        Metas trimestrais
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="scores">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" min="0" step="100" class="form-control"
                                                id="score_captured_properties" name="score_captured_properties"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" min="0" step="100" class="form-control"
                                                id="score_captured_exclusives" name="score_captured_exclusives"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" min="0" step="100" class="form-control"
                                                id="score_published_ads" name="score_published_ads"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" min="0" step="100" class="form-control"
                                                id="score_plaques" name="score_plaques"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" min="0" step="100" class="form-control"
                                                id="score_sales" name="score_sales"
                                ...
                                <div role="tabpanel" class="tab-pane" id="targets">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" step="1000" class="form-control"
                                                style="width: 50%" id="target_first_quarter" name="target_first_quarter"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" step="1000" class="form-control"
                                                style="width: 50%" id="target_second_quarter"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" step="1000" class="form-control"
                                                style="width: 50%" id="target_third_quarter" name="target_third_quarter"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="0" step="1000" class="form-control"
                                                style="width: 50%" id="target_fourth_quarter"
